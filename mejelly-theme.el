...
(let ((class '((class color) (min-colors 89)))
      (mejelly-fg "#eaead8") (mejelly-bg "#151515")

      (mejelly-orange-0 "#fdb86b")

      (mejelly-yellow-0 "#f9cf80") (mejelly-yellow-1 "#ffff00")

      (mejelly-blue-0 "#447898") (mejelly-blue-1 "#7798d4") (mejelly-blue-2 "#91bfdb") (mejelly-blue-3 "#7d93b6")
      ...
      (custom-theme-set-faces
       ...
       `(cursor ((,class (:background ,mejelly-grey-1))))
       ...
       `(diredp-dir-priv ((,class (:foreground ,mejelly-green-1 :background ,mejelly-bg))))
       ...
       `(eshell-ls-directory ((,class (:weight normal :foreground ,mejelly-green-1))))
       ...
       `(fringe ((,class (:foreground ,mejelly-fg :background ,mejelly-grey-2))))
       ...
       `(helm-source-header ((,class (:foreground ,mejelly-red-1 :background ,mejelly-grey-3))))
       ...
       `(magit-diff-file-header ((,class (:inherit nil :foreground ,mejelly-red-2 :background ,mejelly-bg))))
       `(magit-diff-hunk-header ((,class (:inherit nil :foreground ,mejelly-yellow-0 :background ,mejelly-bg))))
       `(magit-item-highlight ((,class (:weight normal :background ,mejelly-bg))))
       `(magit-log-author ((,class (:foreground ,mejelly-fg))))
       `(magit-log-sha1 ((,class (:foreground ,mejelly-red-0 :background ,mejelly-bg))))
       `(magit-log-head-label-local ((,class (:foreground ,mejelly-fg))))
       `(magit-section-title ((,class (:foreground ,mejelly-fg :background ,mejelly-bg))))
       `(magit-whitespace-warning-face ((,class (:background ,mejelly-red-1))))
       `(minibuffer-prompt ((,class (:foreground ,mejelly-fg :background ,mejelly-bg))))
       `(mode-line ((,class (:foreground ,mejelly-fg :background nil))))
       `(mode-line-inactive ((,class (:foreground ,mejelly-grey-3 :background nil))))
       ...
       `(smerge-markers ((,class (:foreground ,mejelly-yellow-0 :background ,mejelly-bg))))
